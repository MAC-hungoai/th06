  ...
  if (!product) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-8">
        ...
        <p className="mt-2 text-sm text-slate-600">Sản phẩm không tồn tại hoặc đã bị xoá.</p>
        <Link
          to="/"
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Bạn có thể quay về danh sách để thêm sản phẩm khác, hoặc vào giỏ hàng để chỉnh số
              lượng.
            </p>
